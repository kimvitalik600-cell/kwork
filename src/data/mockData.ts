...
export const mockObjects: CatalogObject[] = [
  ...
  {
    id: 'obj-7', slug: 'steam-key-top-game-2024',
    title: { ru: 'Steam-ключ: Action RPG (2024)', uk: 'Steam-ключ: Action RPG (2024)', en: 'Steam Key: Action RPG (2024)', pl: 'Klucz Steam: Action RPG (2024)' },
    shortDescription: { ru: 'Активация через Steam. Регион: мировой. Новый ключ, автовыдача.', uk: 'Активація через Steam. Регіон: світовий. Новий ключ, автовидача.', en: 'Steam activation. Region: worldwide. New key, auto delivery.', pl: 'Aktywacja przez Steam. Region: globalny. Nowy klucz, automatyczna dostawa.' },
    fullDescription: { ru: '', uk: '', en: '', pl: '' },
    type: 'digital', status: 'available', categoryId: 'cat-3',
    compensation: 650, compensationCredits: 65, currency: 'UAH',
    images: ['/placeholder-7.jpg'], hasUnpacking: false, hasPdfProtocol: false,
    deliveryType: 'auto', internationalShipping: true,
    viewCount: 512, commentCount: 7, createdAt: '2026-04-06T10:00:00Z', updatedAt: '2026-04-11T10:00:00Z',
  },
  {
    id: 'obj-8', slug: 'instagram-account-10k',
    title: { ru: 'Аккаунт Instagram: 10K подписчиков', uk: 'Акаунт Instagram: 10K підписників', en: 'Instagram Account: 10K followers', pl: 'Konto Instagram: 10K obserwujących' },
    shortDescription: { ru: 'Живая аудитория, тематика: лайфстайл. Полная передача доступов.', uk: 'Жива аудиторія, тематика: лайфстайл. Повна передача доступів.', en: 'Real audience, niche: lifestyle. Full access transfer.', pl: 'Żywa publiczność, niszowa: lifestyle. Pełne przekazanie dostępów.' },
    fullDescription: { ru: '', uk: '', en: '', pl: '' },
    type: 'digital', status: 'available', categoryId: 'cat-4',
    compensation: 8500, compensationCredits: 850, currency: 'UAH',
    images: ['/placeholder-8.jpg'], hasUnpacking: false, hasPdfProtocol: false,
    deliveryType: 'manual', internationalShipping: false,
    viewCount: 294, commentCount: 4, createdAt: '2026-04-07T10:00:00Z', updatedAt: '2026-04-11T10:00:00Z',
  },
  {
    id: 'obj-9', slug: '3d-model-character-pack',
    title: { ru: '3D-модель: Персонаж (риггированный)', uk: '3D-модель: Персонаж (рігований)', en: '3D Model: Rigged Character', pl: 'Model 3D: Postać (zrigowana)' },
    shortDescription: { ru: 'Готовый риггированный 3D-персонаж в форматах FBX/OBJ/Blender. 4K текстуры.', uk: 'Готовий рігований 3D-персонаж у форматах FBX/OBJ/Blender. 4K текстури.', en: 'Ready-to-use rigged 3D character in FBX/OBJ/Blender formats. 4K textures.', pl: 'Gotowy zrigowany model 3D w formatach FBX/OBJ/Blender. Tekstury 4K.' },
    fullDescription: { ru: '', uk: '', en: '', pl: '' },
    type: 'digital', status: 'available', categoryId: 'cat-6',
    compensation: 1800, compensationCredits: 180, currency: 'UAH',
    images: ['/placeholder-9.jpg'], hasUnpacking: false, hasPdfProtocol: false,
    deliveryType: 'auto', internationalShipping: true,
    viewCount: 167, commentCount: 2, createdAt: '2026-04-04T10:00:00Z', updatedAt: '2026-04-11T10:00:00Z',
  },
  {
    id: 'obj-10', slug: 'ai-landscape-pack-20',
    title: { ru: 'AI-арт: Пейзажи (20 изображений)', uk: 'AI-арт: Пейзажі (20 зображень)', en: 'AI Art: Landscapes Pack (20 images)', pl: 'AI Art: Krajobrazy (20 obrazów)' },
    shortDescription: { ru: '20 уникальных пейзажей в 4K. Коммерческая лицензия. Немедленная выдача.', uk: '20 унікальних пейзажів у 4K. Комерційна ліцензія. Негайна видача.', en: '20 unique landscapes in 4K. Commercial license. Instant delivery.', pl: '20 unikalnych krajobrazów 4K. Licencja komercyjna. Natychmiastowa dostawa.' },
    fullDescription: { ru: '', uk: '', en: '', pl: '' },
    type: 'ai_content', status: 'available', categoryId: 'cat-7',
    compensation: 380, compensationCredits: 38, currency: 'UAH',
    images: ['/placeholder-10.jpg'], hasUnpacking: false, hasPdfProtocol: false,
    deliveryType: 'auto', internationalShipping: false,
    viewCount: 308, commentCount: 3, createdAt: '2026-04-09T10:00:00Z', updatedAt: '2026-04-11T10:00:00Z',
  },
  {
    id: 'obj-11', slug: 'tg-channel-promo-5000',
    title: { ru: 'Продвижение Telegram-канала: 5000 подписчиков', uk: 'Просування Telegram-каналу: 5000 підписників', en: 'Telegram Channel Promo: 5000 subscribers', pl: 'Promocja kanału Telegram: 5000 subskrybentów' },
    shortDescription: { ru: 'Реальные подписчики. Срок: 14 дней. Постепенное добавление. Гарантия 30 дней.', uk: 'Реальні підписники. Термін: 14 днів. Поступове додавання. Гарантія 30 днів.', en: 'Real subscribers. 14 days. Gradual growth. 30-day guarantee.', pl: 'Prawdziwi subskrybenci. 14 dni. Stopniowy wzrost. Gwarancja 30 dni.' },
    fullDescription: { ru: '', uk: '', en: '', pl: '' },
    type: 'service', status: 'available', categoryId: 'cat-5',
    compensation: 2200, compensationCredits: 220, currency: 'UAH',
    images: ['/placeholder-11.jpg'], hasUnpacking: false, hasPdfProtocol: false,
    deliveryType: 'manual', internationalShipping: false,
    viewCount: 441, commentCount: 11, createdAt: '2026-04-08T10:00:00Z', updatedAt: '2026-04-11T10:00:00Z',
  },
  {
    id: 'obj-12', slug: 'sneakers-lot-4545',
    title: { ru: 'Кроссовки мужские (Лот #4545)', uk: 'Кросівки чоловічі (Лот #4545)', en: 'Men\'s Sneakers (Lot #4545)', pl: 'Buty sportowe męskie (Lot #4545)' },
    shortDescription: { ru: 'Извлечено из короба №21. Размер 42. Состояние: как новые.', uk: 'Вилучено з коробу №21. Розмір 42. Стан: як нові.', en: 'Extracted from box #21. Size 42. Condition: like new.', pl: 'Wydobyte z kartonu #21. Rozmiar 42. Stan: jak nowe.' },
    fullDescription: { ru: '', uk: '', en: '', pl: '' },
    type: 'material', status: 'available', categoryId: 'cat-1', subcategoryId: 'cat-1-1',
    compensation: 1900, compensationCredits: 190, currency: 'UAH',
    images: ['/placeholder-12.jpg'], hasUnpacking: true, hasPdfProtocol: true,
    deliveryType: 'manual', countryOfOrigin: 'EU', internationalShipping: true,
    boxLabel: 'EU-2024-003-21',
    viewCount: 233, commentCount: 0, createdAt: '2026-04-10T10:00:00Z', updatedAt: '2026-04-11T10:00:00Z',
  },
  {
    id: 'obj-13', slug: 'photoshop-actions-pack',
    title: { ru: 'Photoshop Actions: 50 эффектов', uk: 'Photoshop Actions: 50 ефектів', en: 'Photoshop Actions: 50 effects', pl: 'Photoshop Actions: 50 efektów' },
    shortDescription: { ru: 'Профессиональные экшены для Photoshop. Совместимы с CC 2018+. Инструкция включена.', uk: 'Професійні екшени для Photoshop. Сумісні з CC 2018+. Інструкція включена.', en: 'Professional Photoshop actions. Compatible with CC 2018+. Instructions included.', pl: 'Profesjonalne akcje Photoshop. Kompatybilne z CC 2018+. Instrukcja w zestawie.' },
    fullDescription: { ru: '', uk: '', en: '', pl: '' },
    type: 'digital', status: 'available', categoryId: 'cat-8',
    compensation: 450, compensationCredits: 45, currency: 'UAH',
    images: ['/placeholder-13.jpg'], hasUnpacking: false, hasPdfProtocol: false,
    deliveryType: 'auto', internationalShipping: true,
    viewCount: 189, commentCount: 6, createdAt: '2026-04-05T10:00:00Z', updatedAt: '2026-04-11T10:00:00Z',
  },
]
